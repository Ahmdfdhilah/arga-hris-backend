...
from app.modules.leave_requests.services.leave_request_service import LeaveRequestService
...
LeaveRequestCommandsDep = Annotated[LeaveRequestCommands, Depends(get_leave_request_commands)]
...
def get_leave_request_service(
    ...
    return LeaveRequestService(queries, commands, employee_queries)
